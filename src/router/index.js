...
const TITLE_MAP = {
  ...
  settings: '设置', 'bug-scanner': 'Bug 检测', 'format-rewrite': '格式改写',
  life: '生活助手', 'writing-assistant': '写作助手', project: '项目管理',
  'not-found': '页面未找到'
}
...
const routes = [
  ...
  { path: '/writing-assistant', name: 'writing-assistant', component: () => import('../views/WritingAssistantView.vue'), meta: { requiresAuth: true, title: '写作助手' } },
  { path: '/guide', redirect: '/writing-assistant' },
  { path: '/polish', redirect: '/writing-assistant' },
  { path: '/life', name: 'life', component: () => import('../views/LifeView.vue'), meta: { requiresAuth: true, title: '生活助手' } },
  { path: '/water', redirect: '/life' },
  { path: '/meal', redirect: '/life' },
  { path: '/project', name: 'project', component: () => import('../views/ProjectView.vue'), meta: { requiresAuth: true, title: '项目管理' } },
  { path: '/milestone', redirect: '/project' },
  { path: '/plan', redirect: '/project' },
  ...
  { path: '/latex-editor', redirect: '/latex-snippets' },
