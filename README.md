...
ResearchHub 是一款面向科研工作者的一站式管理平台，覆盖从日常打卡、实验记录到论文写作的完整科研流程。项目采用 Vue 3 + Vite 构建，所有数据本地存储，开箱即用，无需后端服务。

## 拥抱 AI

ResearchHub 从诞生之初就与 AI 深度融合：

- **AI 辅助开发**：整个项目由 Claude Code 驱动开发，从架构设计、代码编写到调试优化，AI 全程参与，大幅提升了开发效率与代码质量。
- **AI 赋能科研**：内置润色提示词、学术翻译、中英文写作指南等 AI 工作流，帮助研究者更高效地完成论文写作与语言润色。
- **AI 原生规划**：后续将接入期刊智能推荐、文献自动追踪、格式一键改写、AI 辅助作图等功能，让 AI 真正成为科研的得力助手。

我们相信，AI 不是替代科研工作者，而是让研究者把更多精力投入到真正有价值的思考与创新中。
